...
if have curl; then curl -fL --retry 2 https://raw.githubusercontent.com/moraroy/NonSteamLaunchers-On-Steam-Deck/main/NonSteamLaunchers.desktop -o "$stage/NonSteamLaunchers.desktop" || true; chmod +x "$stage/NonSteamLaunchers.desktop" 2>/dev/null || true; fi
