...
PAGES = {
'apps list': ('List selectable desktop apps, choices and installation status.', 'Read-only. Installed does not certify login or application behavior. Covers Zen, Zed, VLC, Plex, Spotify, VS Code and Flatseal.', 'apps list'),
