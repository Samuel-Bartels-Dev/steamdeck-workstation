# USB delivery — v0.2.30

Extract `STEAMDECK-SETUP-v0.2.30.zip`. The established wrapper contains:

- `STEAMDECK-SETUP/README-FIRST.txt`
- `STEAMDECK-SETUP/INSTALL.sh`
- `STEAMDECK-SETUP/steamdeck-workstation-v0.2.30.tar.gz`
...
The separate `steamdeck-workstation-v0.2.30-SHA256SUMS.txt` verifies the two delivered
archives. Use `sha256sum --check steamdeck-workstation-v0.2.30-SHA256SUMS.txt` with
