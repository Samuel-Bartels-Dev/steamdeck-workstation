# deckctl command manual — v0.2.35
...
EXAMPLES
  deckctl update apply --archive ~/Downloads/steamdeck-workstation-v0.2.35.tar.gz
...
EXAMPLES
  deckctl update preview --archive ~/Downloads/steamdeck-workstation-v0.2.35.tar.gz
