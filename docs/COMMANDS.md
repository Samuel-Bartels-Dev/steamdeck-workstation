# deckctl command manual — v0.2.26
...
usage: deckctl [-h] [--version]
       {detect,plan,apply,verify,doctor,inventory,support-bundle,post-update,ui,storage,game,remote,backup,restore,travel,ai,repo,profile,launcher,channel,update,export,emulation,media,network,health,terminal,controller,library,aliases,desktop,decky,android,workspace,setup,help}
       ...
...
EXAMPLES
  deckctl update apply --archive ~/Downloads/steamdeck-workstation-v0.2.26.tar.gz
...
EXAMPLES
  deckctl update preview --archive ~/Downloads/steamdeck-workstation-v0.2.26.tar.gz
