# deckctl command manual — v0.2.39
...
EXAMPLES
  deckctl update apply --archive ~/Downloads/steamdeck-workstation-v0.2.39.tar.gz
...
EXAMPLES
  deckctl update preview --archive ~/Downloads/steamdeck-workstation-v0.2.39.tar.gz
