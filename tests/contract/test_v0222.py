...
class Preservation(unittest.TestCase):
    def test_previous_release_preserved_outside_named_patch(self):
        ...
        self.assertEqual((ROOT/'VERSION').read_text().strip(),'0.2.26')
        for path in ('tests/fixtures/baseline-v0.2.18.json','tests/fixtures/baseline-v0.2.19.json','tests/fixtures/baseline-v0.2.20.json'):
