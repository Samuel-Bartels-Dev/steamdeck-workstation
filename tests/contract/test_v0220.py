...
class Review(unittest.TestCase):
    ...
    def test_help_errors_version_and_no_abbreviations(self):
        self.assertEqual(self.run_cli('--version').stdout.strip(),(ROOT/'VERSION').read_text().strip())
    ...
    def test_profile_export_allowlist_and_roundtrip(self):
        ...
        core.save_json(core.CONFIG_HOME/'css-selection.json', {'selected': ['Round'], 'palette': 'ocean'})
        ...
        core.save_json(core.CONFIG_HOME/'css-selection.json', {'selected': [], 'palette': 'graphite'})
        reliability.profile_import(str(arc))
        self.assertEqual(core.load_json(core.CONFIG_HOME/'css-selection.json', {}), {'selected': ['Round'], 'palette': 'ocean'})
