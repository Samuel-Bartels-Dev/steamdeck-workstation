...
if r.returncode:
    sys.exit(r.returncode)
for script in ['tests/contract/test_v0220.py','tests/contract/test_v0221.py','tests/contract/test_v0222.py','tests/contract/test_v0223.py','tests/contract/test_v0224.py','tests/contract/test_v0225.py','tests/contract/test_v0226.py','tests/contract/test_containers.py','tests/contract/test_desktop_apps.py','tests/contract/test_app_choices.py','tests/contract/test_ai_workspace.py','tests/contract/test_setup_window.py','tests/contract/test_component_options.py','tools/check-docs.py']:
